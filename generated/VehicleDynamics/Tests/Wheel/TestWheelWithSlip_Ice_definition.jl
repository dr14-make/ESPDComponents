...
============================================================================
"""
@component function TestWheelWithSlip_Ice(; name)
  __params = Any[]
  __vars = Any[]
  __systems = System[]
  __guesses = Dict()
  ...
  ### Components
  push!(__systems, @named wheel = ESPDComponents.VehicleDynamics.Components.WheelWithSlip(radius=0.3, J=0.5, B=4, C=2, D=0.1, E=1))
  ...
  push!(__systems, @named torque_cmd = BlockComponents.Ramp(height=2000, duration=10, start_time=0, offset=0))
  push!(__systems, @named ground_rot = RotationalComponents.Fixed())
  push!(__systems, @named body = TranslationalComponents.Mass(m=500))
  push!(__systems, @named damper = TranslationalComponents.Damper(d=20))
  ...
  push!(__systems, @named normal_cmd = BlockComponents.Constant(k=2000))
  push!(__systems, @named ground_normal = TranslationalComponents.Fixed())

  ### Guesses
  __guesses[wheel.F_traction] = (0)
  __guesses[wheel.kappa] = (0)
  __guesses[wheel.N] = (2000)
