...
@doc Markdown.doc"""
   TestWheelWithSlip_DryTarmac(; name)
"""
@component function TestWheelWithSlip_DryTarmac(; name)
  __params = Any[]
  __vars = Any[]
  __systems = System[]
  __guesses = Dict()
  ...
  ### Components
  push!(__systems, @named wheel = ESPDComponents.VehicleDynamics.Components.WheelWithSlip(radius=0.3, J=0.5, B=10, C=1.9, D=1, E=0.97))
...
export TestWheelWithSlip_DryTarmac
