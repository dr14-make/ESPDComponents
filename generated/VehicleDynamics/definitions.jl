...
if isfile(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "VehicleDynamics", "definitions.jl"))
  include(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "VehicleDynamics", "definitions.jl"))
end
