...
"""
@component function TestWheel_NoSlip_Snow(; name)
  __params = Any[]
  __vars = Any[]
  __systems = System[]
  __guesses = Dict()
  ...
  ### Components
  push!(__systems, @named wheel = ESPDComponents.VehicleDynamics.Components.Wheel(radius=0.3, mu=0.3, J=0.5))
  ...
  push!(__systems, @named torque_cmd = BlockComponents.Ramp(height=1500, duration=10, start_time=0, offset=0))
