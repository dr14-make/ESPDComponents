...
"""
@component function TestWheelWithSlip_NoSlip(; name)
  __params = Any[]
  __vars = Any[]
  __systems = System[]
  __guesses = Dict()
  ...
  push!(__systems, @named torque_cmd = BlockComponents.Constant(k=600))
...
export TestWheelWithSlip_NoSlip
