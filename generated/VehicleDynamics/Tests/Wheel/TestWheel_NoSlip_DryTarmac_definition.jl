...
@doc Markdown.doc"""
   TestWheel_NoSlip_DryTarmac(; name)
...
============================================================================
"""
@component function TestWheel_NoSlip_DryTarmac(; name)
  __params = Any[]
  __vars = Any[]
  __systems = System[]
  __guesses = Dict()
  ...
  ### Components
  push!(__systems, @named wheel = ESPDComponents.VehicleDynamics.Components.Wheel(radius=0.3, mu=1, J=0.5))
  ...
  push!(__systems, @named torque_cmd = BlockComponents.Ramp(height=600, duration=10, start_time=0, offset=0))
  push!(__systems, @named ground_rot = RotationalComponents.Fixed())
  push!(__systems, @named body = TranslationalComponents.Mass(m=800))
  push!(__systems, @named damper = TranslationalComponents.Damper(d=30))
...
export TestWheel_NoSlip_DryTarmac
