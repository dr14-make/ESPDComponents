...
@doc Markdown.doc"""
   TestWheel_LoadTransfer_7000N(; name)
"""
@component function TestWheel_LoadTransfer_7000N(; name)
  __params = Any[]
  __vars = Any[]
  __systems = System[]
  __guesses = Dict()
...
export TestWheel_LoadTransfer_7000N
