...
@doc Markdown.doc"""
   TestWheelWithSlip_Snow(; name)
"""
@component function TestWheelWithSlip_Snow(; name)
  __params = Any[]
  __vars = Any[]
  __systems = System[]
  __guesses = Dict()
  ...
  ### Components
  push!(__systems, @named wheel = ESPDComponents.VehicleDynamics.Components.WheelWithSlip(radius=0.3, J=0.5, B=5, C=2, D=0.3, E=1))
